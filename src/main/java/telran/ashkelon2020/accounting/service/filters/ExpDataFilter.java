...
@Service
@Order(20)
public class ExpDataFilter implements Filter {
	...
	private boolean checkPathAndMethod(String path, String method) {
		...
		res = res || ("Put".equalsIgnoreCase(method) 
				...
				(("Put".equalsIgnoreCase(method)||"Delete".equalsIgnoreCase(method)||"Post".equalsIgnoreCase(method)) &&
				(path.contains("/forum/post/")));
		return res;
	}
